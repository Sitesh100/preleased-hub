...
function SectionLabel({
  ...
  return (
    <div className="mb-5 flex items-center gap-2">
      ...
      <span className={invert ? "text-[11px] font-semibold uppercase tracking-widest text-white/70" : "text-[11px] font-semibold uppercase tracking-widest text-(--ink-900)/70"}>
        {children}
      </span>
    </div>
  );
...
export default function FeaturesSection() {
  ...
  return (
    <>
      ...
      {/* ─── FEATURED DEALS ────────────────────────────────── */}
      <section className="bg-[linear-gradient(180deg,#f7faff_0%,#edf3fa_100%)] py-14 sm:py-16 lg:py-20">
        <div ref={dealRef} className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
          ...
          >
            <h2 className="font-display text-3xl font-bold tracking-tight text-(--navy) sm:text-4xl md:text-5xl">
              ...
              <span className="italic text-(--ink-900)">income</span> and growth
            </h2>
            <p className="mt-4 max-w-2xl text-base text-(--slate-500)">
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-12">
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            ...
            >
              <SectionLabel invert>Why PreleaseHub</SectionLabel>
              <h2 className="font-display text-3xl font-bold leading-tight text-white sm:text-4xl md:text-5xl">
                Not just property.<br />
                <span className="italic text-white/88">Structured</span> income assets.
              </h2>
            ...
            >
              {TRUST.map((point, i) => (
                <motion.div
                  ...
                  custom={i}
                  className="flex items-start gap-3 rounded-2xl border border-white/12 bg-white/10 p-4 text-sm text-white/88 backdrop-blur"
                >
        ...
        <div className="grid gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <h2 className="font-display text-3xl font-bold text-(--navy) sm:text-4xl md:text-5xl">
              Built to feel<br />
              <span className="italic text-(--ink-900)">credible</span>, focused,<br />
              and premium
            </h2>
